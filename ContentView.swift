...
//[ ] 9. if the 3 cards are not a match, deselect the other 3 and select the 4th (even if it was one of the 3)
//[ ] 10. a) deal 3 button must replace a set of 3 if possible
//[ ] 10. b) deal 3 button must add 3 new cards if 0,1,2, or 3 cards selected (if no set)
