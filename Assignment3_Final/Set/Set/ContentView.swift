...
struct ContentView: View {
 ...
 //TODO: -
        ...
        //[X] 6. Indicate if match or not. Cards must look different than just normal, and different than just selected
        //[X] 7. Support "deselection" (only if 1 or 2 cards selected)
        //[X] 8. a) On a match: replace 3 cards with 3 new ones.
//[?] 8. b) adjust view when there are no more cards to draw
        //[X] 8. c) if tapped card not part of set, select it
...
//[ ] 10. a) deal 3 button must replace a set of 3 if possible
        //[X] 10. b) deal 3 button must add 3 new cards if 0,1,2, or 3 cards selected (if no set) and NOT affect the selection
        //[X] 10. c) deal 3 button must be disabled if no more cards.
        //[X] 11. New game button starts a new game
...
//[?] 17. must use a closure
        //[X] 18. should work in portrait and landscape
